...
![[外链图片转存失败,源站可能有防盗链机制,建议将图片保存下来直接上传(images\image-20210315164044604.png)]](image/24.jpg)
...
```bash
> docker run -d --name rabbitmq -e RABBITMQ_DEFAULT_USER=admin -e RABBITMQ_DEFAULT_PASS=admin -p 9500:5672 -p 9600:15672 -p9700:15692 rabbitmq:3-management
# 5672     amqp
